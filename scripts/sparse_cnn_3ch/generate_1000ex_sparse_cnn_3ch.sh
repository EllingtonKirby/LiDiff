...
weights='checkpoints/all_objects_cleaned_aligned_1_epoch=499.ckpt'
...
python tools/object_generation_multi_gpu.py -c $config -w $weights -s train -r $replaced_dir --permutation_file $permutation_file --limit_samples_count $limit_samples_count
python tools/object_generation_multi_gpu.py -c $config -w $weights -s val   -r $replaced_dir --permutation_file $permutation_file --limit_samples_count $limit_samples_count
